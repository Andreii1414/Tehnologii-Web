...
<body>
    ...
    <div class="content">
        ...
        <?php if($userSession->isConnected() == 1) echo "<h7>Selecteaza categoria</h7>"; 
        else echo '<h7 style="color:red">Trebuie sa fii conectat pentru a putea selecta o categorie!</h7>'?> 
        <div class="line1">
            <div class="wrapper"
             <?php if($userSession->isConnected() == 1) echo 'onclick="window.location.href=\'avertizare/start.html\'"' ?>>
        ...
        <div class="wrapper" 
        <?php if($userSession->isConnected() == 1) echo 'onclick="window.location.href=\'interzicereRestrictie/start.html\'"' ?>>
        ...
        <div class="wrapper" 
        <?php if($userSession->isConnected() == 1) echo 'onclick="window.location.href=\'prioritate/start.html\'"' ?>>
        <p class="pct" id="Prioritate">Punctaj la acest quiz: 0</p>
          ...
          <div class="line1">
            <div class="wrapper"
            <?php if($userSession->isConnected() == 1) echo 'onclick="window.location.href=\'obligare/start.html\'"' ?>>
            <p class="pct" id="Obligare">Punctaj la acest quiz: 0</p>
            <img src="obligatorie.jpeg" alt="Photo 4">
            <p class="photo-caption">De obligare</p>
        </div>
        <div class="wrapper"
        <?php if($userSession->isConnected() == 1) echo 'onclick="window.location.href=\'informare/start.html\'"' ?>>
        ...
        <div class="wrapper"
        <?php if($userSession->isConnected() == 1) echo 'onclick="window.location.href=\'orientare/start.html\'"' ?>>
        <p class="pct" id="Orientare">Punctaj la acest quiz: 0</p>
          ...
          <div class="line1">
            <div class="wrapper"
            <?php if($userSession->isConnected() == 1) echo 'onclick="window.location.href=\'informareTuristica/start.html\'"' ?>>
        ...
        <div class="wrapper" 
        <?php if($userSession->isConnected() == 1) echo 'onclick="window.location.href=\'panouriAditionale/start.html\'"' ?>>
        ...
        <div class="wrapper"
        <?php if($userSession->isConnected() == 1) echo 'onclick="window.location.href=\'semnaleLuminoase/start.html\'"' ?>>
        <p class="pct" id="SemnaleLuminoase">Punctaj la acest quiz: 0</p>
          ...
          <div class="line1">
            <div class="wrapper"
            <?php if($userSession->isConnected() == 1) echo 'onclick="window.location.href=\'caleFerata/start.html\'"' ?>>
        ...
        <div class="wrapper"
        <?php if($userSession->isConnected() == 1) echo 'onclick="window.location.href=\'indicatoareKilometrice/start.html\'"' ?>>
        ...
        <div class="wrapper" 
        <?php if($userSession->isConnected() == 1) echo 'onclick="window.location.href=\'mijloaceAuxiliare/start.html\'"' ?>>
        <p class="pct" id="Auxiliare">Punctaj la acest quiz: 0</p>
          ...
          <div class="line1" >
            <div class="wrapper"
            <?php if($userSession->isConnected() == 1) echo 'onclick="window.location.href=\'benziReversibile/start.html\'"' ?>>
        ...
        <div class="wrapper"
        <?php if($userSession->isConnected() == 1) echo 'onclick="window.location.href=\'marcajeLongitudinale/start.html\'"' ?>>
        ...
        <div class="wrapper" 
        <?php if($userSession->isConnected() == 1) echo 'onclick="window.location.href=\'marcajeTransversale/start.html\'"' ?>>
        <p class="pct" id="MarcajeTransversale">Punctaj la acest quiz: 0</p>
          ...
          <div class="line1">
            <div class="wrapper" 
            <?php if($userSession->isConnected() == 1) echo 'onclick="window.location.href=\'marcajeDiverse/start.html\'"' ?>>
        ...
        <div class="wrapper" 
        <?php if($userSession->isConnected() == 1) echo 'onclick="window.location.href=\'marcajeLaterale/start.html\'"' ?>>
        ...
        <div class="wrapper"
        <?php if($userSession->isConnected() == 1) echo 'onclick="window.location.href=\'indicatoareTemporare/start.html\'"' ?>>
