...
<body>
    ...
    <div class="content">
        ...
        <div class="middle-content">
            <img src="level4.png" alt="lvl4" class="image">
        </div>
        <div class="right-content">
            <p class="text">Alege semnul care trebuie montat in locul patratului 1 pentru a interzice DOAR vehiculului din imagine sa vireze la dreapta</p>
            <div class="image-list">
                ...
                <img src="../../mediu/categorii/interzicererestrictie/semne/interzis-mopede.png" alt="1" class="draggable" valid="valid1">
